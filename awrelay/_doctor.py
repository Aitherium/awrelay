...
SELF = 'awrelay'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['adk', 'awgit']
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWRELAY_A2A_URL', 'AWRELAY_NICK', 'AWRELAY_TOKEN', 'AWRELAY_URL']
