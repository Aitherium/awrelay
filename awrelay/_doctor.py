"""Stack-aware `doctor` for awrelay.
...
interesting failures live BETWEEN them. "awrelay is installed" is not the useful
fact -- "awrelay is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWRELAY_A2A_URL', 'AWRELAY_INBOX_CHANNEL', 'AWRELAY_NICK', 'AWRELAY_SESSION_ID', 'AWRELAY_TOKEN', 'AWRELAY_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrelay needs at runtime, and a
